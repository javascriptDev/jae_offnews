...
//                var currentY = Math.round(parseInt(document.querySelector('.jex-cpt-list').style.webkitTransform.split(',')[1]));
//                document.querySelector('#add .jex-cpt-button-inner').innerText = additionDistance;
